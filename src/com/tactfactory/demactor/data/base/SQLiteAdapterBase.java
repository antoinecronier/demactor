/**************************************************************************
 * SQLiteAdapterBase.java, demactor Android
 *
 * Copyright 2016
 * Description : 
 * Author(s)   : Harmony
...
import com.tactfactory.demactor.data.DemactorSQLiteOpenHelper;
...
public abstract class SQLiteAdapterBase<T> {
    ...
    public static final String TAG = "DemactorSQLiteAdapterBase";
     ...
     * Open Helper.
     */
    protected DemactorSQLiteOpenHelper mBaseHelper;
    ...
    protected SQLiteAdapterBase(final android.content.Context ctx) {
        this.ctx = ctx;
        this.mBaseHelper = new DemactorSQLiteOpenHelper(
                ctx,
                DB_NAME,
                null,
                DemactorApplication.getVersionCode(ctx));
