/**************************************************************************
 * DemactorMenuBase.java, demactor Android
 *
 * Copyright 2016
 * Description : 
 * Author(s)   : Harmony
 ...
 *
 **************************************************************************/
package com.tactfactory.demactor.menu.base;
...
import com.tactfactory.demactor.menu.CrudCreateMenuWrapper;
import com.tactfactory.demactor.menu.CrudDeleteMenuWrapper;
import com.tactfactory.demactor.menu.CrudEditMenuWrapper;
import com.tactfactory.demactor.menu.SaveMenuWrapper;

/**
 * DemactorMenuBase.
 * This class is regenerated with harmony.
 * To modify or learn more about this class,
 * please see DemactorMenu.
 */
public abstract class DemactorMenuBase {
    /** Crudcreate value. */
     ...
     */
    protected DemactorMenuBase(final android.content.Context ctx)
                                                        throws Exception {
        this(ctx, null);
    }
