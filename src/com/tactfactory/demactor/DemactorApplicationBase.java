/**************************************************************************
 * DemactorApplicationBase.java, demactor Android
 *
 * Copyright 2016
 * Description : 
 * Author(s)   : Harmony
 ...
 * Harmony.
 * You should edit DemactorApplication class instead of this
 * one or you will lose all your modifications.</i></b>
 *
 */
public abstract class DemactorApplicationBase extends Application {

    /** TAG for debug purpose. */
    protected static final String TAG = "DemactorApplication";
    /** Singleton. */
    private static volatile DemactorApplicationBase singleton;
    /** Date format. */
     ...
     */
    private static void setSingleton(DemactorApplicationBase application) {
        if (singleton == null) {
     ...
     */
    public static DemactorApplicationBase getApplication() {
        return singleton;
    }
    ...
    public static String getVersion(final android.content.Context ctx) {
        final SharedPreferences settings = ctx.getSharedPreferences(
                DemactorApplicationBase.PREFS_PUBL,
                android.content.Context.MODE_PRIVATE);

        return settings.getString(DemactorApplicationBase.PREFS_VERS, "");
    }
    ...
    public static void setVersion(final android.content.Context ctx) {
        ...
        editor.putString(
            DemactorApplicationBase.PREFS_VERS,
            currentVersion);
