/**************************************************************************
 * HarmonyGridFragment.java, demactor Android
 *
 * Copyright 2016
 * Description : 
 * Author(s)   : Harmony
...
public abstract class HarmonyGridFragment<T> extends Fragment implements LoaderManager.LoaderCallbacks<List<T>> {
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        ...
        try {
            DemactorMenu.getInstance(this.getActivity(), this).clear(menu);
            DemactorMenu.getInstance(this.getActivity(), this).updateMenu(menu, this.getActivity());
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        try {
            result = DemactorMenu.getInstance(this.getActivity(), this).dispatch(item, this.getActivity());
        } catch (Exception e) {
            e.printStackTrace();
            result = false;
        }
