/**************************************************************************
 * DemactorProviderBase.java, demactor Android
 *
 * Copyright 2016
 * Description : 
 * Author(s)   : Harmony
 ...
 *
 **************************************************************************/
package com.tactfactory.demactor.provider.base;
...
import com.tactfactory.demactor.provider.PoneyProviderAdapter;
import com.tactfactory.demactor.provider.PoneytoJockeyProviderAdapter;
...
/**
 * DemactorProviderBase.
 */
public class DemactorProviderBase extends ContentProvider {
    /** TAG for debug purpose. */
    protected static String TAG = "DemactorProvider";
    /** Uri not supported. */
    ...
    /* Tools / Common. */
    /** com.tactfactory.demactor.provider authority. */
    public static String authority = "com.tactfactory.demactor.provider";
    /** URI Matcher. */
    ...
    public boolean onCreate() {
        ...
        if (!DemactorProvider.CREATE_DATABASE_DEFERRED) {
            this.loadAdapters();
        }
    ...
    public void loadAdapters() {
        ...
        JockeyProviderAdapter jockeyProviderAdapter = new JockeyProviderAdapter(this);
        this.db = jockeyProviderAdapter.getDb();
        this.providerAdapters.add(jockeyProviderAdapter);
        this.providerAdapters.add(new PoneyProviderAdapter(this));
        this.providerAdapters.add(new PoneytoJockeyProviderAdapter(this));
        this.providerAdapters.add(new ScoreProviderAdapter(this));
        this.providerAdapters.add(new UserProviderAdapter(this));
    ...
    public static void initializeDatabase(Context context) {
        context.getContentResolver().call(
                DemactorProviderBase.generateUri(),
                DemactorProviderBase.INITIALIZE_DATABASE,
                null,
                null);
    }
}
