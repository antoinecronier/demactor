/**************************************************************************
 * PoneyListFragment.java, demactor Android
 *
 * Copyright 2016
 * Description : 
 * Author(s)   : Harmony
...
/** Poney list fragment.
 *
 * This fragment gives you an interface to list all your Poneys.
 *
 * @see android.app.Fragment
 */
public class PoneyListFragment
        extends HarmonyListFragment<Poney>
        implements CrudCreateMenuInterface {

    /** The adapter which handles list population. */
    protected PoneyListAdapter mAdapter;
    ...
    public View onCreateView(
        ...
        final View view =
                inflater.inflate(R.layout.fragment_poney_list,
                        null);

        this.initializeHackCustomList(view,
                R.id.poneyProgressLayout,
                R.id.poneyListContainer);
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        this.setEmptyText(this.getString(
                R.string.poney_empty_list));

        // Create an empty adapter we will use to display the loaded data.
        this.mAdapter = new PoneyListAdapter(this.getActivity(), null);
    ...
    public Loader<android.database.Cursor> onCreateLoader(int id, Bundle bundle) {
        ...
        if (crit != null) {
            result = new PoneyListLoader(this.getActivity(),
