/**************************************************************************
 * JockeyListFragment.java, demactor Android
 *
 * Copyright 2016
 * Description : 
 * Author(s)   : Harmony
...
/** Jockey list fragment.
 *
 * This fragment gives you an interface to list all your Jockeys.
 *
 * @see android.app.Fragment
 */
public class JockeyListFragment
        extends HarmonyListFragment<Jockey>
        implements CrudCreateMenuInterface {

    /** The adapter which handles list population. */
    protected JockeyListAdapter mAdapter;
    ...
    public View onCreateView(
        ...
        final View view =
                inflater.inflate(R.layout.fragment_jockey_list,
                        null);

        this.initializeHackCustomList(view,
                R.id.jockeyProgressLayout,
                R.id.jockeyListContainer);
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        this.setEmptyText(this.getString(
                R.string.jockey_empty_list));

        // Create an empty adapter we will use to display the loaded data.
        this.mAdapter = new JockeyListAdapter(this.getActivity(), null);
    ...
    public Loader<android.database.Cursor> onCreateLoader(int id, Bundle bundle) {
        ...
        if (crit != null) {
            result = new JockeyListLoader(this.getActivity(),
